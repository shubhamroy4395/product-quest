    ...
    <div className="resources-page">
      ...
      <section className="resources-grid">
        <div className="resource-card">
          ...
          <a href="#" className="resource-link">Explore Strategy Resources</a>
        </div>
        
        <div className="resource-card">
          <h2>User Research</h2>
          <p>Master the art of understanding user needs and behaviors</p>
          <a href="#" className="resource-link">Explore Research Resources</a>
        </div>
        
        <div className="resource-card">
          <h2>Agile & Scrum</h2>
          <p>Deep dive into agile methodologies and scrum practices</p>
          <a href="#" className="resource-link">Explore Agile Resources</a>
        </div>
      </section>
    </div>
  );
